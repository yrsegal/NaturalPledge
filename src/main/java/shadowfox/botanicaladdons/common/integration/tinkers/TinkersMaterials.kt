...
object TinkersMaterials {
    ...
    val manasteel = mat("manasteel", MANASTEEL_COLOR)
    val terrasteel = mat("terrasteel", TERRASTEEL_COLOR)
    val elementium = mat("elementium", ELEMENTIUM_COLOR)

    val soulroot = mat("soulroot", SOULROOT_COLORS[0])
    val livingwood = mat("livingwood", LIVINGWOOD_COLOR)
    val dreamwood = mat("dreamwood", DREAMWOOD_COLOR)

    val livingrock = mat("livingrock", LIVINGROCK_COLOR)
