...
class TraitSoulbonded : AbstractTrait("soulbonded", TinkersIntegration.SOULROOT_COLORS[0]) {
    ...
    override fun onUpdate(tool: ItemStack?, world: World?, entity: Entity, itemSlot: Int, isSelected: Boolean) {
        ...
        val skylight = (entity.worldObj.getLightFor(EnumSkyBlock.SKY, entity.position) * entity.worldObj.provider.getSunBrightnessFactor(1F)).toInt()
        val blocklight = entity.worldObj.getLightFor(EnumSkyBlock.BLOCK, entity.position)
