 ...
 */
open class ItemModFood(name: String, foodValue: Int, saturation: Float, isWolfFood: Boolean, vararg variants: String) : ItemFood(foodValue, saturation, isWolfFood), ModelHandler.IVariantHolder {
